...
export default function TalkToAIComponent() {
  ...
  return (
    ...
    <div className="max-w-2xl w-full mx-auto p-6 bg-white rounded-xl shadow-lg">
      <h2 className="text-2xl font-bold text-center mb-6 text-gray-800">Talk to AI Assistant</h2>
      ...
      <div className="w-full"></div>
        ...
        {loeading ? (
          <div className="flex justify-center items-center h-full">
            <div className="animate-pulse text-blue-600">Processing your request...</div>
          </div>
        ) : (
          <p className="text-gray-800 whitespace-pre-wrap">{response || "Response will appear here"}</p>
        )}
        </div>
      </div>
